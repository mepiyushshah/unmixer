...
export default function AppPage() {
  ...
  // Check if file was uploaded from homepage
  useEffect(() => {
    if (searchParams.get('uploaded') === 'true') {
      const fileDataStr = sessionStorage.getItem('uploadedFile');
      const fileBlobUrl = sessionStorage.getItem('uploadedFileBlob');
      
      if (fileDataStr && fileBlobUrl) {
        const fileData = JSON.parse(fileDataStr);
        
        // Recreate file from blob URL
        fetch(fileBlobUrl)
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        ...
        <div className="text-center mb-16">
          <h1 className="text-6xl font-bold text-gray-900 mb-4 tracking-tight">
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Unmixer</span> Studio
          </h1>
